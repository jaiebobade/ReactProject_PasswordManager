...
const Manager = () => {
  ...
  const savePassword = async () => {
    //  if(form.site.length >3 && form.site.username.length >3 && form.site.password.length >3){
  ...
  return (
    <>
      ...
      <div className="p-3 md:mycontainer min-h-[89.3vh]">
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          <button onClick={savePassword} className='flex justify-center items-center gap-2 bg-green-400 hover:bg-green-300 rounded-full px-8 py-2 w-fit border
border-green-900'>
            <lord-icon
            ...
            <tbody className='bg-green-100'>
              {passwordArray.map((item, index) => {
                ...
                return <tr key={index}>
                  ...
                  <td className='py-2 border border-white text-center'> <span> {item.username} </span>
                  ...
                  <td className='py-2 border border-white text-center'> <span>{item.password}</span>
